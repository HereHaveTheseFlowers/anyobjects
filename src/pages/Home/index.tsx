    ...
    return (
        <>
            ...
            <h1 className='home__h1'>
                <span className="∀-fix">∀</span> НУ — КУРАТОРСКИЙ ПРОЕКТ ПРО РОССИЙСКОЕ ПРОИЗВОДСТВО. МЫ СОЗДАЛИ АРХИВ ОБЪЕКТОВ, КОТОРЫЕ МЫ НАШЛИ КРАСИВЫМИ.
            </h1>
            <FiltersTab />
            <ObjectGrid />
            <Footer />
            <button className="home__arrow" onClick={handleArrow} aria-label="Иконка стрелочки вверх" ref={arrowRef}>
